...
Status codes are a 3-digit integer code giving the result of the attempt to understand and satisfy the request.
...
`7xx` | **Developer Error** | [err](http://www.urbandictionary.com/define.php?term=err) | 7xx-rfc
